 ...
 const [message,setmessage]=useState(initialState);
      ...
      const handleClick=async()=>{
        try{
            ...
            const res = await fetch(
                "http://localhost:4000/api/company/setMessage",
                {
                  method: "PUT",
                  headers: {
  ...
  return (
    <div className="box">
          ...
          <button className="mx-4 my-3 font-medium text-gray-100 bg-blue-500 hover:bg-blue-600 font-poppins px-4 py-2 rounded-lg " onClick={handleClick}> Send </button>
        </div>
  )
}
