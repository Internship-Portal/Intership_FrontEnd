    ...
    const getMessages=async()=>{
        try{
            ...
            const res = await fetch(
                "http://localhost:4000/api/officer/getMessage",
                {
                  method: "POST",
                  headers: {
    ...
    <div className="bg-white flex">
      ...
      <div className="flex-[3]">
        ...
        <hr className="h-0 border-r-[0.5px] border-solid border-[#E6E3E3]" />
          ...
          <div class="p-6">
            <p class="mb-1 text-base text-neutral-600 font-poppins">
            ...
            <div className="flex flex-row justify-normal items-center gap-9">
              <p class="mb-1 text-base text-neutral-600 flex flex-row justify-normal items-center ">
                ...
                {msg.department_name.map((dept) => (
                  <div className="p-1 m-1 rounded-lg bg-gray-100">{dept}</div>
                ))}
              </p>
              <p class="mb-1 text-base text-neutral-600 flex flex-row justify-normal items-center ">
                Year:
