    ...
    <div>
      ...
      <div className='flex flex-col items-center text-center sm:text-left mt-6'>
        ...
        <div className="flex items-center justify-center w-3/4">
          <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50  hover:bg-secondary text-black">
            ...
            <input id="dropzone-file" type="file" name="csv" className="hidden" onChange={handleChange} />
          </label>
        </div>
        ...
        <div className='w-3/4'>
          ...
          <input className="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" name="csv" onChange={handleChange}/>
